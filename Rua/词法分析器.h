...
public:
    // 定义token都有什么类型
    enum 令牌类型 {
        函数关键字=1, 如果关键字=2, 那么关键字=3, 否则关键字=4, 或者关键字=5, 返回关键字=6, 当关键字=7,
        变量关键字=8, 数组关键字=9,
        标识符=10, 数字=11, 字符串=12,
        左括号=13, 右括号=14, 左中括号=15, 右中括号=16, 左花括号=17, 右花括号=18, 逗号=19, 分号=20, 等号=21, 加号=22, 减号=23,
        乘号=24, 除号=25, 等于=26, 不等于=27, 大于=28, 小于=29, 模=30, 乘方=31, 整除=32,
        加等于=33, 减等于=34, 乘等于=35, 除等于=36, 乘方等于=37, 模等于=38, 整除等于=39,
        换行符=40, 结束=41
    };
